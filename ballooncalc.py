...
h = 2000  #m, set altitude
m_pl = 2000 #kg, base station mass
...
m_mat = V_mat * 1370 #kg
print "With a base station of", m_pl,"kg, at",h, "m altitude, need a baloon volume of", V_ball, 'm^3 and a helium mass of', M_he ,'kg'
